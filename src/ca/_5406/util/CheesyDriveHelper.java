 ...
 * https://github.com/Team254/FRC-2017-Public/blob/master/src/com/team254/lib/util/CheesyDriveHelper.java
 */
public class CheesyDriveHelper {
  ...
  public void updateCheesyDriveValues(double throttle, double wheel, boolean isQuickTurn, boolean isHighGear){
    
    wheel = Util.applyDeadband(wheel, kWheelDeadband);
    throttle = Util.applyDeadband(throttle, kThrottleDeadband);
